...
const ReferPeople = () => {
	...
	return (
		...
		<Col xs="12" className="mt-5">
			...
			<Modal visible={isModalVisible} onCancel={onClose} footer={false} bodyStyle={{ height: 290 }} maskClosable={false} width={400} title="Refer people" className="selectCallTypeModal referModal">
